...
#if RAGE
[assembly: Rage.Attributes.Plugin("LemonUI Example")]
#endif
...
#elif RAGE
        private static void Basics_Tick()
#endif
        {
...
#elif RAGE
            if (Game.IsControlJustPressed(0, GameControl.MultiplayerInfo) && !menu.Visible && !submenu.Visible)         
#endif
            {
                menu.Visible = true;
            }
