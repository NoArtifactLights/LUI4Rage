...
namespace LemonUI.Menus
{
	...
	public class NativeMenu : IContainer<NativeItem>
	{
		...
		internal static List<GameControl> controlsRequired = new List<GameControl>
		{
			...
			GameControl.VehiclePushbikeFrontBrake,
			GameControl.VehiclePushbikeRearBrake,
			// Flying
			GameControl.VehicleFlyThrottleUp,
			GameControl.VehicleFlyThrottleDown,
			GameControl.VehicleFlyYawLeft,
			GameControl.VehicleFlyYawRight,
			GameControl.VehicleFlyRollLeftRight,
			GameControl.VehicleFlyRollLeftOnly,
			GameControl.VehicleFlyRollRightOnly,
			GameControl.VehicleFlyPitchUpDown,
			GameControl.VehicleFlyPitchUpOnly,
			GameControl.VehicleFlyPitchDownOnly,
		...
		/// </summary>
		internal static readonly List<GameControl> controlsCamera = new List<GameControl>
		{
		...
		/// </summary>
		internal static readonly List<GameControl> controlsGamepad = new List<GameControl>
		{
			GameControl.Aim,
			GameControl.Attack
		};
...
#if RAGE
			GameControl.CellphoneSelect
#else
			Control.PhoneSelect
#endif
			), new InstructionalButton("Back",
#if RAGE
			GameControl.CellphoneCancel
#else
			Control.PhoneCancel
#endif
			))
...
#region Private Functions
		...
		private void ProcessControls()
		{
			...
			bool backPressed = Controls.IsJustPressed(GameControl.CellphoneCancel) || Controls.IsJustPressed(GameControl.FrontendPause);
			bool upPressed = Controls.IsJustPressed(GameControl.CellphoneUp) || Controls.IsJustPressed(GameControl.CursorScrollUp);
			bool downPressed = Controls.IsJustPressed(GameControl.CellphoneDown) || Controls.IsJustPressed(GameControl.CursorScrollDown);
			bool selectPressed = Controls.IsJustPressed(GameControl.FrontendAccept) || Controls.IsJustPressed(GameControl.CellphoneSelect);
			bool clickSelected = Controls.IsJustPressed(GameControl.CursorAccept);
			bool leftPressed = Controls.IsJustPressed(GameControl.CellphoneLeft);
			bool rightPressed = Controls.IsJustPressed(GameControl.CellphoneRight);
#else
			// Check if the controls necessary were pressed
...
namespace LemonUI.Rage
{
	...
	public static class GameplayCamera
	{
		...
		{
			get => NativeFunction.Natives.GET_GAMEPLAY_CAM_RELATIVE_HEADING<float>();
			set => NativeFunction.Natives.SET_GAMEPLAY_CAM_RELATIVE_HEADING(value);
		}
	}
}
#endif